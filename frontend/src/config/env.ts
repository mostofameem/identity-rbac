...
export const config = {
  ...
  // Portal URLs
  customerPortalUrl: process.env.REACT_APP_CUSTOMER_PORTAL_URL || 'http://localhost:3001',
  adminPortalUrl: process.env.REACT_APP_ADMIN_PORTAL_URL || 'http://localhost:3000',
