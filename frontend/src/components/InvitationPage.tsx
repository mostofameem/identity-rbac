            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  value={email}
                  readOnly
                  className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 bg-gray-50 text-gray-500 focus:outline-none sm:text-sm"
                />
              </div>
            </div>
