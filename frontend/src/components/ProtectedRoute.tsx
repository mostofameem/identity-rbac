    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50">
        <div className="text-center">
          <svg className="animate-spin h-9 w-9 text-primary-600 mx-auto" fill="none" viewBox="0 0 24 24">
  ...
  if (requiredPermission && !hasRequiredPermission) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 px-6">
        <div className="text-center">
          <div className="mx-auto grid place-items-center h-14 w-14 rounded-full bg-primary-50">
          ...
          <p className="mt-2 text-slate-500 text-sm">You don't have permission to access this page.</p>
        </div>
      </div>
    );
  }
