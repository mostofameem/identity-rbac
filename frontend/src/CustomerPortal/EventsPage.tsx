...
const EventsPage: React.FC = () => {
    ...
    const fetchEvents = async () => {
        try {
            setLoading(true);
            const response = await apiClient.getEvents({ mode: status });
                ...
                <div className="grid gap-6">
                    {events.map((event) => (
                        ...
                        >
                            ...
                            <div className="bg-gray-50 rounded-2xl p-4 flex flex-row flex-wrap gap-x-8 gap-y-3">
                                ...
                                <div className="flex items-center gap-3 flex-grow min-w-[150px]">
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="flex-grow h-1.5 bg-gray-200 rounded-full overflow-hidden max-w-[100px]">
                                                <div
                            ...
                            <div className="mt-6">
                                <button
                                    className="w-full py-3 bg-indigo-600 hover:bg-indigo-700 active:scale-[0.98] text-white rounded-xl font-bold text-sm shadow transition-all duration-200"
